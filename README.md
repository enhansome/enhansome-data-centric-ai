...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,682 | 🐛 325 | 🌐 Python | 📅 2026-04-22 - YData Profiling supports both Pandas and Spark DataFrames, providing a fast and straightforward visual  data understanding.
* [Great Expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,742 | 🐛 41 | 🌐 Python | 📅 2026-08-27 - Great Expectations helps data teams eliminate pipeline debt, through data testing, documentation, and profiling.
...
* [SweetViz](https://github.com/fbdesignpro/sweetviz) ⭐ 3,120 | 🐛 41 | 🌐 Python | 📅 2026-04-11 - SweetViz is an open-source Python library that generates beautiful, high-density visualizations to kickstart EDA (Exploratory Data Analysis) with just two lines of code.
...
* [AutoViz](https://github.com/AutoViML/AutoViz) ⭐ 1,898 | 🐛 2 | 🌐 Python | 📅 2024-06-10 - Automatically Visualize any dataset, any size with a single line of code.
...
* [LabelStudio](https://github.com/heartexlabs/label-studio) ⭐ 28,157 | 🐛 927 | 🌐 TypeScript | 📅 2026-08-27 - Label Studio is an open-source data labeling tool. It lets you label data types like audio, text, images, videos, and time series with a simple and straightforward UI and export to various model formats.
...
* [LabelMe](https://github.com/wkentaro/labelme) ⭐ 16,131 | 🐛 181 | 🌐 Python | 📅 2026-08-25 - LabelMe is an image polygonal annotation tool that uses Python and Qt.
* [LightlyStudio](https://github.com/lightly-ai/lightly-studio) ⭐ 877 | 🐛 47 | 🌐 Python | 📅 2026-08-27 - LightlyStudio is an open source tool for curating, annotating, and managing vision datasets (images and videos). It supports embedding-based auto-selection, annotation, and auto-labeling for bounding boxes, segmentation, and captions.
...
* [DataFlow](https://github.com/OpenDCAI/DataFlow) ⭐ 7,782 | 🐛 9 | 🌐 Python | 📅 2026-08-18 - LLM-ready data preparation system for turning raw PDFs, conversations, code, and databases into SFT, QA, and RAG-ready datasets.
